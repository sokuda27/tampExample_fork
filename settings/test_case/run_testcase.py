...
def setup_blocks_and_robot(robot):
    ...
    block_names = ['block_a.urdf', 'block_a.urdf', 'block_a.urdf', 'block_a.urdf', 'block_a.urdf']
    blocks = []
...
def initialize_flat(robot, blocks):
    ...
    blocks[0].set_point([0.3, 0.0, table_top_z])
    blocks[1].set_point([0.3, 0.1, table_top_z])
    blocks[2].set_point([0.3, -0.1, table_top_z])
    blocks[3].set_point([0.5, 0.0, table_top_z])
    blocks[4].set_point([0.5, 0.1, table_top_z])
